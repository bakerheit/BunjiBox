...
import { defaultBots, makeBot, patchBot, legacyBot, validId } from '../shared/bots.js'
import { computerProfile, defaultComputerProfile, machineComputerProfile, storedComputerProfile } from '../shared/agent-permissions.js'
