...
export async function avatarGenerationRequest(job, action, signal) {
...
export async function cancelAvatarGeneration(job, creation, signal) {
...
export async function normalizeAvatarImage(source) {
  let blob = source
